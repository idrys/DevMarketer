...
class RoleController extends Controller
{
    ...
    public function show($id)
    {
        ...
        //$permissions = Permission::all();
        return view('manage.roles.show')->withRole($role);//->withPermissions($permissions);
    }
    /**
    ...
    {
        //var_dump($request->display_name);
        //var_dump($request->permissions);
        ...
        Session::flash('sucess', 'Sucessfully update the '. $role->display_name . ' role in the database');
